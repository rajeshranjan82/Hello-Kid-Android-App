...
public class School_Near_Me extends FragmentActivity implements
        OnMapReadyCallback,
        ...
        LocationListener
{
    ...
    private Marker currectuerLocationMarker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school__near__me);
        ...
        switch (v.getId())
        {
            case R.id.searchbutton:
                ...
                if(!TextUtils.isEmpty(address))
                {
                    ...
                    try
                    {
                        addressList=geocoder.getFromLocationName(address,15);
                        ...
                        {
                            Toast.makeText(this,"Place not found",Toast.LENGTH_SHORT);
                        }
                    }
                    catch (IOException e)
                    {
    ...
    public void onLocationChanged(Location location) {
        ...
        if(currectuerLocationMarker != null)
        {
            currectuerLocationMarker.remove();
        }
        ...
        currectuerLocationMarker= mMap.addMarker(markerOptions);
